...
import useStore from "../../../store/store/useStore"; // Importamos useStore
...
const Header = ({ onNote }) => {
  ...
  // Obtenemos el usuario del store de Zustand
                  ...
                  <Dropdown className="header-profile2">
                    ...
                    >
                      <div className="header-info2 d-flex align-items-center">
                        <div className="d-flex align-items-center sidebar-info">
                          <div>
                            <h6 className="font-w500 mb-0 ms-2">{userName}</h6>
                          </div>
                    ...
                    <Dropdown.Menu className="dropdown-menu-end">
                      ...
                      <Link to="./setting" className="dropdown-item ai-icon">
                        ...
                        <span className="ms-2">Configuraciones </span>
                      </Link>
                      <LogoutPage />
                    </Dropdown.Menu>
                  </Dropdown>
